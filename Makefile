...
APPNAME ="Dogecoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),nesteggcoin)
# Egg
DEFINES   += BIP44_COIN_TYPE=3 BIP44_COIN_TYPE_2=3 COIN_P2PKH_VERSION=33 COIN_P2SH_VERSION=34 COIN_FAMILY=1 COIN_COINID=\"Nesteggcoin\" COIN_COINID_HEADER=\"NESTEGGCOIN\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"Nesteggcoin\" COIN_COINID_SHORT=\"EGG\" COIN_KIND=COIN_KIND_EGG
APPNAME ="Nesteggcoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
